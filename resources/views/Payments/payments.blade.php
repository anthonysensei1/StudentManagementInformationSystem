...
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="btn_list">
                    ...
                    <div class="buttons">
                        <button class="btn btn-outline-success btn-md mt-2 mb-2"
                            onclick="toggleTables(this)">Payments Report</button>
                    </div>
                </div>
            </div>
            <!-- GradeLevelandFeesTableArea -->
            <div class="buttons" id="newEntryButton">
                <button class="btn btn-outline-success mt-2 mb-2" data-toggle="modal" data-target="#newEntry">
                    <i class="fas fa-plus"></i>
                    New Entry
                </button>
            </div>
            <table id="example1" class="table table-bordered table-striped mt-2" id="gradeLevelTable">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-outline-success btn-md" data-toggle="modal"
                                data-target="#showTable">Show Table</button>
                            <butotn class="btn btn-outline-primary btn-md"  data-toggle="modal" data-target="#updateEntry">
            ...
            <!-- Payments TableArea -->
            <div> THIS TABLE WILL APPEAR WHEN PAYMENTS REPORT BUTTON IS CLICKED</div>
...
<div class="modal fade" id="showTable" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="print_btn">
                    <button class="btn btn-outline-secondary btn-md">Print</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table id="example4" class="table table-bordered">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <button class="btn btn-outline-success btn-md" data-toggle="modal" data-target="#managePayment">
                                        Manage Payment
                                    </button>
                                </td>
                            </tr>
...
<div class="modal fade" id="managePayment" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-gradient-secondary">
                ...
                <table class="table table-bordered mt-2">
                    ...
                    <tbody class="text-center">
                        <tr>
                            ...
                            <td>760</td>
                            <td>
                                <button class="btn btn-success btn-md">Pay</button>
                            </td>
                        </tr>
                        <tr>
                            <td>July</td>
            ...
            <form action="{{ route('payments_update') }}" class="formPost">
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control students_id" name="students_id" id=" u_h_students_id"
                        readonly hidden>
                    <input type="text" class="form-control balance" name="balance" id=" u_h_balance" readonly hidden>
                    <div class="sdata">
                    ...
                    <div class="sdata">
                        ...
                        <input type="text" class="form-control form-control-md student_balance" name="ob" id="u_ob"
                            readonly>
                    </div>
                    <div class="sdata">
                        <label>Amount</label>
                        <input type="number" class="form-control form-control-md amount" name="amt" id="u_amt" required
                            placeholder="P 00.00">
                    </div>
                    <div class="sdata">
                        <label>Remarks</label>
                        <textarea class="form-control form-control-md remarks" rows="3" cols="" name="remarks"
                            id="u_remarks" placeholder="..."></textarea>
                    </div>
                </div>
                    ...
                    <div class="FeeEntryMainDiv">
                        <div class="details">
                            ...
                            <div class="month_new">
                                ...
                                <select class="form-control" name="payment_freq" id="payment_freq" required>
                            ...
                            <div class="month_new">
                                ...
                                <input type="text" class="form-control" name="date_started" id="date_started">
                            </div>
                            <div class="month_new">
                ...
                <div class="modal-body">
                    <div class="FeeEntryMainDiv">
                        <div class="details">
                            ...
                            <div class="grdlvl">
                                <label>Grade Level</label>
                                <select class="form-control" name="sgrade" id="u_sgrade" required>
                                    <option value="" disabled selected>Select Grade</option>
                                </select>
                            </div>
                            <div class="month_new">
                                <label>School Year</label>
                                <select class="form-control" name="year" id="u_year" required>
                                    <option value="" disabled selected>Select Year</option>
                                </select>
                            </div>
                            <div class="month_new">
                                <label>Payment Frequency</label>
                                <select class="form-control" name="payment_freq" id="u_payment_freq" required>
                                    <option value="">Weekly</option>
                                    <option value="">Monthly</option>
                                    <option value="">Annually</option>
                                </select>
                            ...
                            <div class="month_new">
                                <label>Date Started</label>
                                <input type="text" class="form-control" name="date_started" id="u_date_started">
                            </div>
                            <div class="month_new">
                                <label>Date End</label>
                                <input type="text" class="form-control" name="date_end" id="u_date_end">
                            </div>
                        </div>
                        <div class="feeDetails">
                            <div class="FD">
                                ...
                                <div class="feeType">
                                    <label>Fee Type</label>
                                    <input type="text" class="form-control" name="feeType" id="u_feeType"
                                        placeholder="fee type">
                                </div>
                                <div class="amount_newtry">
                                    <label>Amount</label>
                                    <input type="number" class="form-control" name="amount" id="u_amount"
                                        placeholder="P 00.00">
                                </div>
                                <div class="addToList">
                                    <button type="button" class="btn btn-secondary btn-sm" onclick="addToList()">
                            ...
                            <div class="TA">
                                <table class="table">
                                    ...
                                    <tbody class="text-center fee_details_list" id="u_fee_details_list">
                                    </tbody>
                                </table>
                                <div class="nfe_div"></div>
                                <div class="totalDiv">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('payments_destroy') }}" class="formPost">
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control students_id" name="students_id" id="students_id" readonly
                        hidden>
                    <input type="text" class="form-control payable_balance" name="payable_balance" id="payable_balance"
                        readonly hidden>
                    <input type="text" class="form-control balance" name="balance" id="balance" readonly hidden>
