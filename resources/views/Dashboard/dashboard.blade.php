      ...
      <div class="container-fluid">
         ...
         <table class="table">
            <tbody>
               <tr>
                     <td>Employee ID :</td>
                     <td> <input type="text" class="form-control" name="t_id" id="t_id" placeholder="employee ID" readonly> </td>
               </tr>
               <tr>
                     <td>Username :</td>
                     <td> <input type="text" class="form-control" name="t_user" id="t_user" placeholder="username" readonly> </td>
               </tr>
               <tr>
                     <td>Address :</td>
                     <td> <input type="text" class="form-control" name="t_address" id="t_address" placeholder="address" readonly> </td>
               </tr>
               <tr>
                     <td>Date of Birth :</td>
                     <td> <input type="date" class="form-control" name="t_dob" id="t_dob" readonly> </td>
               </tr>
               <tr>
                     <td>Gender :</td>
                     <td> <input type="text" class="form-control" name="t_gender" id="t_gender" placeholder="gender" readonly> </td>
               </tr>
               <tr>
                     <td>Email Address :</td>
                     <td> <input type="text" class="form-control" name="t_eadd" id="t_eadd" placeholder="email address" readonly> </td>
               </tr>
               <tr>
                     <td>Contact No. :</td>
                     <td> <input type="text" class="form-control" name="t_contact_no" id="t_contact_no" placeholder="ex.09123456789" readonly> </td> 
               </tr>
               <tr>
                     <td>Date Created :</td>
                     <td> <input type="date" class="form-control" name="t_date" id="t_date" readonly> </td>
               </tr>
            </tbody>
         </table> -->
