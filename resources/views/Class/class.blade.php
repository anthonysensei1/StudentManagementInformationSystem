        ...
        <div class="container-fluid pt-2">
            ...
            <table id="example1" class="table table-bordered table-striped mt-2">
                ...
                <tbody>
                    ...
                    @else
                    <tr>
                        <td colspan="3" class="text-center">No data is displayed!</td>
                    </tr>
                    @endif
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td><a href="#" class="student_name view" data-toggle="modal"
                                ...
                                data-target="#studentListModal">Grade {{ $teachers_subject_class['current_grade'] }}</a>
                        </td>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    <td>ID No. :</td>
                                    <td> <a href="#" id="student_grade_id_no"></a> </td>
                                </tr>
                                <tr>
                                    <td>LRN :</td>
                                    <td id="student_grade_lrn"></td>
                                </tr>
                                <tr>
                                    <td>Name :</td>
                                    <td id="student_grade_name"></td>
                                </tr>
                                <tr>
                                    <td>Grade Level :</td>
                                    <td id="student_grade_level"></td>
                                </tr>
                                <tr>
                                    <td>Section :</td>
                                    <td id="student_grade_section"></td>
                                </tr>
                            </tbody>
                        </table>
                        <!-- EndTable -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('class_store_grade') }}" class="formPost">
                            <input type="text" class="form-control" name="student_id" class="student_id" id="student_id"
                                readonly hidden>
                            <input type="text" class="form-control" name="sub_in" class="sub_in" id="sub_in" disabled>
                            <input type="text" class="form-control" name="sub_in_id" class="sub_in_id" id="sub_in_id"
                                readonly hidden>
                            <div class="ag_label">
                                Add Grade
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>1st Quarter</td>
                                        <td> <input type="number" class="form-control" name="quarter_1" id="quarter_1"
                                                placeholder="0.0" min="50" max="100"> </td>
                                    </tr>
                                    <tr>
                                        <td>2nd Quarter</td>
                                        <td> <input type="number" class="form-control" name="quarter_2" id="quarter_2"
                                                placeholder="0.0" min="50" max="100"> </td>
                                    </tr>
                                    <tr>
                                        <td>3rd Quarter</td>
                                        <td> <input type="number" class="form-control" name="quarter_3" id="quarter_3"
                                                placeholder="0.0" min="50" max="100"> </td>
                                    </tr>
                                    <tr>
                                        <td>4th Quarter</td>
                                        <td> <input type="number" class="form-control" name="quarter_4" id="quarter_4"
                                                placeholder="0.0" min="50" max="100"> </td>
                                    </tr>
                                    <tr>
                                        <td>Final Rating</td>
