                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" class="form-control" name="contact_number"
                                            id="contact_num" required placeholder="Ex.09123456789">
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="employee_id" id="u_employee_id"
                                            required placeholder="employee ID">
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="contact_number"
                                            id="u_contact_num" required placeholder="Ex.09123456789">
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" class="form-control" name="age" id="u_age"
                                            required>
                                    </div>
                                    <div class="col-lg-3">
                                        <span class="g_label">Gender</span>
                                    ...
                                    <tbody>
                                       @foreach ($subjects as $subject)
                                           <tr class="text-center"
                                               ...
                                               <td>
                                                   <div class="icheck-primary">
                                                       <input type="checkbox" class="u_check2" name="subjects[]"
                                                           value="{{ $subject['id'] }}"
